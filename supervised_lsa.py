...
# JSON dump wd, D_ and U_ for use in other files

json.dump(U_.tolist(), open('U_', 'w'))
json.dump(D_.tolist(), open('D_', 'w'))
json.dump(V_.tolist(), open('V_', 'w'))
json.dump(wd, open('wd', 'w'))
